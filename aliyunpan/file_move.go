...
// Move 移动文件
func (p *PanClient) Move(param []*FileMoveParam) ([]*FileMoveResult, *apierror.ApiError) {
	// url
	...
	// data
	requests,e := p.getBatchRequestList(param)
	if e != nil {
		return nil, e
	}
...
func (p *PanClient) getBatchRequestList(param []*FileMoveParam) (BatchRequestList, *apierror.ApiError) {
	if param == nil {
